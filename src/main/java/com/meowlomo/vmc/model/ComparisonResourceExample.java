...
public class ComparisonResourceExample {
    ...
    public ComparisonResourceExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addUuidCriterion(String condition, Object value, String property) {
            ...
            uuidCriteria.add(new Criterion(condition, value, "com.meowlomo.ems.api.mybatis.typehandler.UUIDTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addUuidCriterion(String condition, UUID value1, UUID value2, String property) {
            ...
            uuidCriteria.add(new Criterion(condition, value1, value2, "com.meowlomo.ems.api.mybatis.typehandler.UUIDTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGroupCriterion(String condition, Object value, String property) {
            ...
            groupCriteria.add(new Criterion(condition, value, "com.meowlomo.ems.api.mybatis.typehandler.GroupTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGroupCriterion(String condition, String value1, String value2, String property) {
            ...
            groupCriteria.add(new Criterion(condition, value1, value2, "com.meowlomo.ems.api.mybatis.typehandler.GroupTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addStatusCriterion(String condition, Object value, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value, "com.meowlomo.ems.api.mybatis.typehandler.StatusTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addStatusCriterion(String condition, String value1, String value2, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value1, value2, "com.meowlomo.ems.api.mybatis.typehandler.StatusTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addOperatingSystemCriterion(String condition, Object value, String property) {
            ...
            operatingSystemCriteria.add(new Criterion(condition, value, "com.meowlomo.ems.api.mybatis.typehandler.OperatingSystemTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addOperatingSystemCriterion(String condition, String value1, String value2, String property) {
            ...
            operatingSystemCriteria.add(new Criterion(condition, value1, value2, "com.meowlomo.ems.api.mybatis.typehandler.OperatingSystemTypeHandler"));
            allCriteria = null;
        }
        ...
        public boolean isValid() {
            return criteria.size() > 0
            	|| uuidCriteria.size() > 0
                || groupCriteria.size() > 0
                || statusCriteria.size() > 0
                || operatingSystemCriteria.size() > 0;
        }
