...
public class WorkerLog implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        WorkerLog other = (WorkerLog) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), createdAt("created_at", "createdAt", "TIMESTAMP", false), message("message",
                "message", "VARCHAR", false), workerId("worker_id", "workerId", "BIGINT", false);
