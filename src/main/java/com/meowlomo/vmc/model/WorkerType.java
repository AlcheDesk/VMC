...
public class WorkerType implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        WorkerType other = (WorkerType) that;
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), name("name", "name", "VARCHAR", false), predefined("is_predefined",
                "predefined", "BIT", false), active("is_active", "active", "BIT", false);
