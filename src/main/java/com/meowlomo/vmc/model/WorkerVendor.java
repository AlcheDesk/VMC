...
public class WorkerVendor implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        WorkerVendor other = (WorkerVendor) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getWorkerId() == null ? other.getWorkerId() == null
                        : this.getWorkerId().equals(other.getWorkerId()))
                && (this.getVendorId() == null ? other.getVendorId() == null
                        : this.getVendorId().equals(other.getVendorId()));
    }
    ...
    public enum Column {
        id("id", "id", "BIGINT", false), workerId("worker_id", "workerId", "BIGINT", false), vendorId("vendor_id",
